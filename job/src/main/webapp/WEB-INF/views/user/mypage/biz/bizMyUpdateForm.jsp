...
function btnMyUpdate(){
	...
	document.frm.action="/user/mypage/biz/bizMyUpdate.do";
	document.frm.submit();
}
		...
		<form action="/user/mypage/biz/bizMyUpdate.do" method="post" id="upForm" name="frm" enctype="multipart/form-data">
			...
			<ul class="list-group">
				...
				<li class="list-group-item" style="background-color: #eef5df;">
					...
					for="company">기업명:</label> <input type="text" class="form-control"
					placeholder=" company" id="company" name="company"
					value="${sessionScope.b_user.company }" required="required" />
				</li>
				<li class="list-group-item" style="background-color: #e3f5bc;">
					<i class="fas fa-star-of-life" style="color: red;"></i> <label
					for="email">이메일:</label> <input type="text" class="form-control"
					placeholder=" email" id="email" name="email"
					value="${sessionScope.b_user.email}" required="required" /> <input
					type="button" value="중복체크" onclick="e_check();"
				...
				<li class="list-group-item" style="background-color: #eef5df;">
					<i class="fas fa-star-of-life" style="color: red;"></i> <label
					for="ceo">대표자:</label> <input type="text" class="form-control"
					placeholder=" ceo" id="ceo" name="ceo"
					value="${sessionScope.b_user.ceo}" required="required" />
				</li>
				<li class="list-group-item" style="background-color: #e3f5bc;">
					<i class="fas fa-star-of-life" style="color: red;"></i> <label
					for="phone">대표자연락처:</label> <input type="text" class="form-control"
					placeholder=" phone" id="phone" name="phone"
					value="${sessionScope.b_user.phone }" required="required" /> <input
					type="button" value="중복체크" onclick="p_check();"
					class="btn btn-warning" />
				</li>
				<li class="list-group-item" style="background-color: #eef5df;">
					<div class="form-group">
						<label for="field"><i class="fas fa-star-of-life"
							style="color: red;"></i>업종:</label> <select class="form-control"
				...
				<li class="list-group-item" style="background-color: #eef5df;">
					<div class="form-group">
						<input class="form-control" style="top: 5px;" placeholder="도로명 주소"
							...
							value="${sessionScope.b_user.addr }" />
					</div>
				</li>
				<li class="list-group-item" style="background-color: #e3f5bc;">
					<div class="form-group">
